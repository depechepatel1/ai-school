    ...
    <PageShell
      ...
      <div className="relative w-full h-full text-white font-outfit select-none animate-fade-in-up">
        ...
        <>
            ...
            <div className="absolute right-5 z-50 flex items-center gap-1 bg-black/40 backdrop-blur-2xl border border-white/[0.06] rounded-xl p-1 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.5)]" style={{ top: 'calc(50% - 10rem)' }}>
