...
const OmniChatModal = forwardRef<HTMLDivElement, OmniChatModalProps>(
  ({ isOpen, onClose }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className="absolute bottom-24 right-6 z-50 w-[280px] bg-gray-900/95 backdrop-blur-xl border border-white/20 rounded-3xl p-3 shadow-[0_30px_60px_rgba(0,0,0,0.9)] animate-fade-in-up border-glow-subtle flex flex-col gap-3"
      >
        {/* Header */}
