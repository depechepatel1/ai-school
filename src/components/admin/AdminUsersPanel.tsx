          ...
          >
            {!bulkConfirm ? (
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => setBulkConfirm({ action: "role" })} className="px-2.5 py-1 rounded-lg text-[9px] font-bold bg-blue-500/15 border border-blue-400/20 text-blue-300 hover:bg-blue-500/25 transition-all">Change Role</button>
              ...
              <div className="flex items-center gap-2">
                ...
                <button disabled={busy} onClick={handleBulkAction} className="px-2.5 py-1 rounded text-[9px] font-bold bg-red-500/20 text-red-300 hover:bg-red-500/30 transition-all disabled:opacity-50">{busy ? "…" : "Confirm"}</button>
