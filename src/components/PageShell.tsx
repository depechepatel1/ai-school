...
const VIDEO_2 = "https://res.cloudinary.com/daujjfaqg/video/upload/2026-02-26T10-21-39_add_head_nodding_knplpb.mp4";
        ...
        <div className="absolute right-0 top-0 bottom-0 w-[40%] min-w-[340px] z-20 flex flex-col justify-center p-8">
          <div className="relative group">
            ...
            <div className="relative w-full max-h-[680px] px-6 py-6 rounded-[2.5rem] bg-black/40 backdrop-blur-3xl border border-white/10 shadow-[0_30px_60px_-10px_rgba(0,0,0,0.9)] flex flex-col overflow-hidden">
              ...
              <div className="relative z-10 w-full overflow-y-auto scrollbar-hide">
                {children}
              </div>
            </div>
          </div>
