...
export default function ProsodyVisualizer({ data, activeWordIndex }: Props) {
  return (
    <div className={`relative min-h-[6rem] w-full max-w-3xl mx-auto flex flex-wrap items-center ${data.length >= 4 ? "justify-between" : "justify-center"} content-center gap-y-4 mt-4 mb-2 px-8`}>
      {data.map((item, i) => {
