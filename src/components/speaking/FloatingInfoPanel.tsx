  ...
  return (
    <div className="bg-black/60 backdrop-blur-2xl border border-white/[0.08] rounded-2xl px-4 py-3 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.5)] max-w-[220px] w-full">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-white/40">Curriculum Info</span>
      </div>
      <div className="space-y-1.5 text-[11px]">
        ...
        <div className="flex items-center gap-2">
          <span className="text-white/40 font-semibold uppercase tracking-wider text-[10px] w-16">Week</span>
          <span className="text-white/80 font-bold">Week {weekNumber}</span>
        </div>
        {questionType && (
          <div className="flex items-center gap-2">
            <span className="text-white/40 font-semibold uppercase tracking-wider text-[10px] w-16">Type</span>
