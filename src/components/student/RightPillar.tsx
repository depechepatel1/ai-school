  ...
  return (
    <div className="absolute top-0 right-0 bottom-24 w-[280px] p-6 flex flex-col gap-4 z-20">
      ...
      <div className="relative group-container">
        <div className="absolute inset-0 rounded-2xl overflow-hidden bg-black/60 border border-white/10 shadow-[0_0_20px_rgba(20,184,166,0.15)] transition-all hover:shadow-[0_0_40px_rgba(20,184,166,0.4)] hover:border-white/30">
            ...
            <AnimatePresence>
              {activeTooltip === 'fire' && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 4 }}
                  className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-max bg-orange-600 text-white text-[10px] font-bold px-3 py-1 rounded-full shadow-lg z-50"
                >
            ...
            <AnimatePresence>
              {activeTooltip === 'ice' && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: 4 }}
                  className="absolute top-full right-0 mt-2 w-32 bg-black/90 border border-cyan-500/30 rounded-lg p-2 text-[10px] text-cyan-100 z-50"
                >
