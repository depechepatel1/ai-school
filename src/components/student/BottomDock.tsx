...
export default function BottomDock({ setShowHomeworkModal, setCalendarOpen, onSignOut, hasHomework = false }: BottomDockProps) {
  ...
  return (
    <div role="navigation" aria-label="Main navigation" className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-30 w-full max-w-[480px] flex justify-center">
