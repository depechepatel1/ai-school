...
export default function BottomDock({ setShowHomeworkModal, setCalendarOpen, onSettings, hasHomework = false }: BottomDockProps) {
  ...
  return (
    <div role="navigation" aria-label="Main navigation" className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-30 w-full max-w-[400px] flex justify-center">
